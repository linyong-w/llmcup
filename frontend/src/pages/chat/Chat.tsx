...
import Azure from "../../assets/PASH.png";
...
const Chat = () => {
    ...
    const clearChat = () => {
        // Call the server to clear chat and user details
        fetch('/conversation?action=clear', { method: 'GET' });
                    ...
                    <div className={styles.chatContainer}>
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Welcome to PASH</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Type in your name below and start your conversation</h2>
                            </Stack>
                        ) : (
                        ...
                        <Stack horizontal className={styles.chatInput}>
                            ...
                            <div
                                ...
                                <BroomRegular
                                    ...
                                    style={{ background: isLoading || answers.length === 0 ? "#BDBDBD" : "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #9a0fbd 33.63%, rgb(170, 62, 197) 70.31%, #9c8ddd 100%)", 
